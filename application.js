...
const eggUtils = require('egg-core/index').utils;

const EggApplication = require('./egg');

//Worker进程的加载 程序目录，比Agent多了很多Service等等
...
class Application extends EggApplication {
  ...
  createContext(req, res) {
    ...
    const context = Object.create(app.context); //创建对象，并且继承app.context
